...
def generate_jnb(dataset, complexity):
    ...
    nb['cells'].append(nbf.v4.new_markdown_cell(text_title))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_warning))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_library))
    nb['cells'].append(nbf.v4.new_code_cell(code_library(dataset)))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_problemType))
    nb['cells'].append(nbf.v4.new_code_cell(run_problemType))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_dataVisualization))
    nb['cells'].append(nbf.v4.new_code_cell(run_dataVisualization))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_outlierDetection))
    nb['cells'].append(nbf.v4.new_code_cell(run_outlierDetection))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_similarity))                   
    nb['cells'].append(nbf.v4.new_code_cell(run_similarity))
    create_block(text_comp, code_comp(str(complexity)))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_featureImportance))
    nb['cells'].append(nbf.v4.new_code_cell(run_featureImportance))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_baselines))                   
    nb['cells'].append(nbf.v4.new_code_cell(run_baselines))
    create_block(text_removeOutliers, run_removeOutliers)
    nb['cells'].append(nbf.v4.new_markdown_cell(text_algorithms))
    nb['cells'].append(nbf.v4.new_code_cell(run_algorithms))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_customAlgorithm))
    nb['cells'].append(nbf.v4.new_code_cell(run_customAlgorithm))
    nb['cells'].append(nbf.v4.new_markdown_cell(text_relativePerformance))                   
